...
public class Sports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef = database.getReference().child("Sports");
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                FirebaseRecyclerAdapter<ModelClass, PDC.BlogViewHolder> searchadapter =
                        new FirebaseRecyclerAdapter<ModelClass, PDC.BlogViewHolder>(ModelClass.class, R.layout.design_row, PDC.BlogViewHolder.class, (Query) database.getReference("Sports").orderByChild("node").equalTo(keyword.toUpperCase())) {
                            @Override
                            protected void populateViewHolder(PDC.BlogViewHolder viewHolder, ModelClass model, int position) {
                                viewHolder.setTitle(model.getTitle());
                                viewHolder.setImage(getApplicationContext(), model.getImage());
